...
{
    public class CarePlanSubActivityPostCreate_OrganizationWideExerciseProgress : IPlugin
    {
        ...
        public EntityCollection getCareplanSubActivities(Guid ContactId, IOrganizationService service)
        {
            ...
            CareplansubactivityQuery.Criteria.AddCondition("hcp_name", ConditionOperator.Like, "%Exercise%");
