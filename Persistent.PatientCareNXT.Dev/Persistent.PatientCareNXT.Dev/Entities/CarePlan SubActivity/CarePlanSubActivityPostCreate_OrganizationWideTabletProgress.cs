...
{
    public class CarePlanSubActivityPostCreate_OrganizationWideTabletProgress : IPlugin
    {
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            try
            {
                               ...
                               context.InputParameters["Target"] is Entity)
                {
                    ...
                    Entity careplansubactivityity = (Entity)context.InputParameters["Target"];
                    // Verify that the target entity represents an careplansubactivity.
                    // If not, this plug-in was not registered correctly.
                    if (careplansubactivityity.LogicalName != "hcp_careplansubactivity")
                        return;
                    tracingService.Trace("Entity Logical name =" + careplansubactivityity.LogicalName);
                    Guid contactId = careplansubactivityity.GetAttributeValue<EntityReference>("hcp_patient").Id;
                    ...
                    tracingService.Trace("CarePlan Subactivities =" + careplanSubActivities);
                    ...
                    foreach (Entity carePlanActivity in careplanSubActivities.Entities)
                    {
                        if (carePlanActivity.Attributes.Contains("hcp_activitydate") && carePlanActivity.Attributes["hcp_activitydate"] != null)
                        {
                            ...
                            carePlan.Attributes["hcp_orgprogressbymonth"] = month_Percent;
